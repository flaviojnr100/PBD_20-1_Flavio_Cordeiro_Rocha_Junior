        ...
        grid.setPrefWidth(574.0);
            ...
            for(int i=0;i<3;i++){
                ...
                for(int j=0;j<linhas+1;j++){
                        ...
                        public void handle(ActionEvent event) {
                            try {
                                ...
                                if(BaseDados.getPedidos().size()>0){
                                    Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("view/FXMLFinalizarPedido.fxml"));
                                    Scene scene = new Scene(root);
                                    Stage stage = new Stage();
                    ...
                    ImageView imagem = new ImageView(new Image(getClass().getClassLoader().getResourceAsStream("asset/mesa.png")));
